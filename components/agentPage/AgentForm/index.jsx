...
const AgentFormComponent = () => {
    ...
    const verifyCodeFunc = () => {
        ...
        if (receptionSmsVerify.status === 'success') localStorage.setItem('receptionUserId', allData.phoneNumber)
    ...
    console.log(receptionSmsVerify.status,'receptionSmsVerify.status');
    console.log(allData.phoneNumber,'allData.phoneNumber');
    useEffect(() => {
